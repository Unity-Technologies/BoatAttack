...
public partial class @InputControls: IInputActionCollection2, IDisposable
{
    ...
    ~@InputControls()
    {
        Debug.Assert(!m_BoatControls.enabled, "This will cause a leak and performance issues, InputControls.BoatControls.Disable() has not been called.");
        Debug.Assert(!m_DebugControls.enabled, "This will cause a leak and performance issues, InputControls.DebugControls.Disable() has not been called.");
    }
